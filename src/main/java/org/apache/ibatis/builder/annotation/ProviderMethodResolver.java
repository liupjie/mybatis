...
public interface ProviderMethodResolver {
   ...
   * }
   * 该方法的作用是从@*Provider 注 解的 type 属性所指向的类中找出 method属性中所指定的方法
   * @param context 包含@*Provider注解中的type值和value值
   * @return 找出的指定方法
   */
  default Method resolveMethod(ProviderContext context) {
    ...
    // 如果没有找到指定的方法，则@*Provider注解中type属性所指向的类中不含有method属性中所指定的方法
