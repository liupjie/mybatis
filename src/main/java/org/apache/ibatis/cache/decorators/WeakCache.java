...
/**
 * WeakCache装饰器通过将缓存数据包装成弱引用的数据，从而使得 JVM可以清理掉缓存数据
 */
public class WeakCache implements Cache {
   ...
   *
   * removeGarbageCollectedItems方法中，我们可以看到当 WeakEntry中的弱引用对象被清理时，
   * 属性 key被用来删除“数据键: 弱引用包装<null>”这条数据。
   */
  ...
  private static class WeakEntry extends WeakReference<Object> {
    //  key属性是强引用的，该变量不会被JVM清理掉，这里存储了目标对象的键
